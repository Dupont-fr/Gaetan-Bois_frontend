    ...
    <AdminLayout>
      <div className='create-category'>
        <div className='page-header'>
          ...
          <p>Créez une catégorie pour organiser vos produits</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className='category-form'>
            ...
            <div className='form-group'>
              ...
              <input
                ...
                placeholder='Ex: Tables, Chaises, Armoires, Lits...'
                required
                autoFocus
              />
            ...
            <div className='info-box'>
              <div style={{ display: 'flex' }}>
                ...
                <div>
                  ...
                  <p>
                    Après la création, vous pourrez ajouter des images à cette
                    catégorie.
                  </p>
                </div>
              </div>
