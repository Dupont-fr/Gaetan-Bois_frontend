    ...
    <div className='homepage'>
      ...
      <header className='hero-header'>
        ...
        <div className='hero-content'>
          <h1 className='brand-name'>GAETAN BOIS</h1>
          <p className='brand-tagline'>Menuiserie Artisanale de Qualité.</p>
          <hr></hr>
          <p className='brand-tagline'>
            Chaque pièce est fabriquée avec passion pour embellir votre
            intérieur.
          </p>
        </div>
      </header>
      ...
      <section className='categories-section'>
        <div className='section-header'>
          <h2>NOS CRÉATIONS EN BOIS.</h2>
          {/* <h2>DÉCOUVREZ NOS CRÉATIONS EN BOIS</h2> */}
          {/* <h2>NOTRE BOIS FAIT SUR MESURE POUR VOUS</h2> */}
          <p className='section-description'>
            Découvrez notre savoir-faire artisanal : lits élégants, armoires
            spacieuses, chaises confortables, fauteuils design, penderies sur
            mesure, tables robustes, buffets raffinés, étagères pratiques et
            bien plus encore.{' '}
