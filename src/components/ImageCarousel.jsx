            ...
            {images.map((image, index) => (
              ...
              >
                ...
                <div className='product-info'>
                  ...
                  {image.dimensions &&
                    (image.dimensions.longueur ||
                      image.dimensions.largeur ||
                      image.dimensions.hauteur) && (
                      <div className='product-dimensions'>
                        <span className='dimensions-label'>Dimensions:</span>
                        <span className='dimensions-value'>
                          {[
                            image.dimensions.longueur &&
                              `L ${image.dimensions.longueur}m`,
                            image.dimensions.largeur &&
                              `l ${image.dimensions.largeur}m`,
                            image.dimensions.hauteur &&
                              `H ${image.dimensions.hauteur}m`,
                          ]
                            .filter(Boolean)
                            .join(' × ')}
                        </span>
                  ...
                  <div className='product-stock'>
                    <span
                      className={`stock-indicator ${image.enStock ? 'in-stock' : 'out-of-stock'}`}
                    ></span>
                    <span className='stock-text'>
                      {image.enStock ? 'En stock' : 'Rupture'}
                    </span>
                  </div>
