...
const Contact = () => {
  ...
  const fullMessage = `*NOUVEAU MESSAGE A GAETAN BOIS*
...
${formData.message}`
  ...
  // Encoder une seule fois tout le message
    ...
    <>
      ...
      <div className='contact-page'>
        <div className='contact-hero'>
          ...
          <p>Nous sommes à votre écoute pour tous vos projets de menuiserie</p>
        </div>
            ...
            {!contactMethod ? (
              <div className='contact-method-choice'>
                ...
                <p className='choice-subtitle'>
                  Sélectionnez comment vous souhaitez nous contacter
                </p>
                ...
                <div className='method-buttons'>
                  ...
                  >
                    ...
                    <div>
                      <h3>Email</h3>
                      <p>Message détaillé avec pièces jointes</p>
                    </div>
                  </button>
                </div>
              </div>
