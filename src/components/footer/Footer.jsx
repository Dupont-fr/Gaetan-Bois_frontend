          ...
          <div className='footer-section'>
            ...
            >
              <p className='footer-description'>
                GAETAN BOIS est votre partenaire de confiance pour la
                réalisation de meubles en bois. De la conception à la livraison,
                nous garantissons un travail artisanal d'exception.
              </p>
              <div className='footer-social'>
                <a
                  href='https://www.facebook.com/gaetan.teguezang.9'
                  target='_blank'
          ...
          <div className='footer-section'>
            ...
            >
              <div className='footer-contact'>
                ...
                <p>
                  <Icon name='map' /> <span>Yaoundé, Cameroun</span>
                </p>
                <hr></hr>
        ...
        <div className='footer-container'>
          <div className='footer-bottom-content'>
            <p className='footer-copyright'>
              © {new Date().getFullYear()} GAETAN BOIS. Tous droits réservés.
            </p>
            <pre> </pre>
