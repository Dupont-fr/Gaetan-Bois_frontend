      ...
      <div className='order-page-wrapper'>
        <header className='order-page-header'>
          <div className='order-page-header-content'>
            <Link to='/' className='brand-link'>
              ...
              <p className='brand-subtitle'>Menuiserie Artisanale</p>
            </Link>
          </div>
        </header>
        ...
        <div className='order-page'>
          <div className='order-error'>
            ...
            <p>Veuillez sélectionner un produit depuis la page d'accueil.</p>
        ...
        <footer className='order-page-footer'>
          <p>&copy; {new Date().getFullYear()} GAETAN BOIS</p>
        </footer>
      </div>
    )
  }
...
*Voir l'image:* ${product.url}`
  ...
  return (
    <div className='order-page-wrapper'>
            ...
            <div className='product-info'>
              ...
              {product.materiau && (
                <div className='info-row'>
                  ...
                  <span className='info-value'>{product.materiau}</span>
                </div>
              )}
      ...
      <footer className='order-page-footer'>
        <p>
          &copy; {new Date().getFullYear()} GAETAN BOIS - Menuiserie Artisanale
        </p>
      </footer>
    </div>
  )
