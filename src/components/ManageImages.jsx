      ...
      <div className='manage-images'>
        ...
        <div className='page-header'>
          <div>
            ...
            <p>Gérez les produits de cette catégorie</p>
          </div>
        </div>
        ...
        {images.length === 0 ? (
          <div className='empty-state'>
            <FrameIcon />
            <h3>Aucun produit</h3>
            <p>Commencez par ajouter des produits à cette catégorie</p>
          </div>
        ) : (
              ...
              {images.map((image, index) => (
                ...
                >
                  ...
                  <div className='image-preview'>
                    ...
                    />
                    {!image.enStock && (
                      <div className='stock-badge rupture'>
                        Rupture de stock
                      </div>
                    )}
                  </div>
      ...
      >
        ...
        <form onSubmit={onSubmit} className='product-form'>
          ...
          <div className='form-section'>
            ...
            <div className='form-group'>
              <label htmlFor='materiau'>Type de bois / Matériau</label>
              <input
                type='text'
                id='materiau'
                name='materiau'
                ...
                onChange={onChange}
                placeholder='Ex: Bois de teck, Chêne...'
              />
            </div>
          </div>
